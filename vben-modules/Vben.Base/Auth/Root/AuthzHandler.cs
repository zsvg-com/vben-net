...
//             }
//
//             foreach (var yperm in SysApiCache.GET_URLS)
//             {
//                 if (yperm.url == url)
//                 {
//                     pos = yperm.pos;
...
//         else if (method == "POST")
//         {
//             foreach (var yperm in SysApiCache.POST_URLS)
//             {
//                 if (yperm.url == url)
//                 {
//                     pos = yperm.pos;
...
//         else if (method == "PUT")
//         {
//             foreach (var yperm in SysApiCache.PUT_URLS)
//             {
//                 if (yperm.url == url)
//                 {
//                     pos = yperm.pos;
...
//         {
//             foreach (var yperm in SysApiCache.DELETE_URLS)
//             {
//                 if (yperm.url == url)
//                 {
//                     pos = yperm.pos;
