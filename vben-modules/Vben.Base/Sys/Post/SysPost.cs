...
[SugarTable("sys_post", TableDescription = "组织架构-岗位")]
[Description("组织架构-岗位")]
public class SysPost : BaseStrMainEntity
{
    ...
    [Navigate(typeof(SysPostOrg), nameof(SysPostOrg.pid), nameof(SysPostOrg.oid))]
